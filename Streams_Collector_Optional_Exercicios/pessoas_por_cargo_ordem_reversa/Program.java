...
public class Program {
    public static void main(String[] args) {
        ...
        TreeMap<String, List<Pessoa>> pessoas1 = ConsultaPessoas.obterPessoasAgrupadasPorCargoEmOrdemReversa(todasPessoas);
        
        TreeMap<String, List<Pessoa>> pessoas2 = ConsultaPessoas.obterPessoasAgrupadasPorCargoEmOrdemReversa(
            List.of(pessoa1, pessoa2, pessoa3, pessoa4, pessoa9, pessoa10)
        );
        
        TreeMap<String, List<Pessoa>> pessoas3 = ConsultaPessoas.obterPessoasAgrupadasPorCargoEmOrdemReversa(
