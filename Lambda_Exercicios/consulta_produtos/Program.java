...
public class Program {
    public static void main(String[] args) {
        ...
        List<Produto> produtosBaixoEstoquePredicate = ConsultaProdutos.filtrarPredicate(produtos, 
            p -> p.getQuantidadeEmEstoque() <= 10);
        ...
        //System.out.println("produtosBaixoEstoquePredicate: " + produtosBaixoEstoquePredicate);
    }
}
